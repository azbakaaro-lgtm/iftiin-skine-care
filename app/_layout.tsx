            ...
            <CartProvider>
              <CareProvider>
                <Stack screenOptions={{ headerShown: false }}>
                  ...
                  <Stack.Screen name="notifications" /><Stack.Screen name="account-profile" /><Stack.Screen name="settings" /><Stack.Screen name="change-password" /><Stack.Screen name="oauth/callback" /><Stack.Screen name="(tabs)" />
                </Stack>
              </CareProvider>
            </CartProvider>
          </PhaseSessionProvider>
